...
<body>
    <div class="header">
        ...
        <a href="assessment5.php" class="back-arrow">← previous</a>
        </div> <div>6 out of 10</div>
    ...
    <div class="container">
        <h2>Which task sounds more appealing?</h2>
        <div class="options">
            <div class="option">
                <!-- Sports Illustration -->
                <img src="image/math.png" alt="Sports">
            ...
            <div class="option">
                ...
                <p>Preparing a meal or working with tools</p>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment7.php"; // Redirect to next question
            } else {
