...
<div class="card mb-4 pulse-animation" id="nocard">
  ...
  <?php endif; ?>
        <div class="d-flex justify-content-end">
          <button type="button" class="btn btn-secondary me-2" onclick="window.location='student_profiling.php'">
            Close
          </button>
          <button type="button" class="btn btn-primary" onclick="window.location='individual_counseling.php?id=<?php echo $student_id; ?>'"> Start Counseling </button>    
            </div>
      </div>
    </main>
  </div>
