...
<body class="bg-gray-100">
    ...
    <h1 class="text-2xl font-bold mb-6 text-center">Communication Record Review</h1>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <p class="p-2 bg-gray-50 rounded">October 15, 2023</p>
                </div>
                <div>
                    <p class="text-sm font-medium mb-1">Time</p>
                    <p class="p-2 bg-gray-50 rounded">2:30 PM</p>
                </div>
                <div>
                    <p class="text-sm font-medium mb-1">Recorded By</p>
                    <p class="p-2 bg-gray-50 rounded">Ms. Sarah Johnson</p>
                </div>
            </div>
            
            <div class="mt-4">
                <p class="text-sm font-medium mb-2">Communication Type</p>
                <div class="flex flex-wrap gap-4">
                    <span class="flex items-center gap-2 bg-green-100 px-3 py-1 rounded-full">
                        ✓ Meeting
                    </span>
                    <span class="flex items-center gap-2 bg-green-100 px-3 py-1 rounded-full">
                        ✓ Phone Call
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h2 class="text-lg font-semibold mb-4">Meeting Summary</h2>
            <div class="space-y-4">
                <div>
                    <p class="text-sm font-medium mb-2">Meeting Type</p>
                    <div class="flex flex-wrap gap-4">
                        <span class="bg-blue-100 px-3 py-1 rounded-full">Parent-Teacher</span>
                    </div>
                </div>
                <div>
                    <p class="text-sm font-medium mb-1">Participants</p>
                    <p class="p-2 bg-gray-50 rounded">John Doe (Parent), Ms. Smith (Teacher), Ms. Johnson (Guidance)</p>
                </div>
                <div>
                    <p class="text-sm font-medium mb-1">Key Discussion Points & Outcomes</p>
                    <div class="p-2 bg-gray-50 rounded">
                        <p>Discussed student's progress in mathematics and upcoming parent-teacher conference schedule. Agreed on weekly progress reports.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div class="p-2 bg-gray-50 rounded">
                <p>Parent expressed concerns about math grades, teacher provided update on recent improvements. Agreed to follow up after next assessment. Discussion about upcoming field trip permissions and logistics.</p>
            </div>
        </div>

        <!-- Action Buttons -->
        <div class="flex justify-end gap-4 mt-6" style="margin-bottom: 20px;">
            <button type="button" class="px-6 py-2 bg-gray-500 text-white rounded hover:bg-gray-600" onclick="window.location='pt_com.php'">Back</button>
            <button type="button" class="px-6 py-2 bg-green-600 text-white rounded hover:bg-green-700" data-bs-toggle="modal" data-bs-target="#confirmationModal2">Save Record</button>
        </div>
    </div>
</main>

<!--  Confirmation Modal -->
<div class="modal fade" id="confirmationModal2" tabindex="-1" aria-hidden="true">
