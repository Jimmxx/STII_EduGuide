    ...
    <div class="flex">
                    ...
                    <table class="min-w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-gray-300 px-4 py-2">hs123</td>   
                                <td class="border border-gray-300 px-4 py-2">
                                <button class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600" data-bs-toggle="modal" data-bs-target="#editTeacherModal">Edit</button>
                                <button class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600" data-bs-toggle="modal" data-bs-target="#delete">Delete</button>
                                </td>
        ...
        <div class="modal fade" id="addTeacherModal" tabindex="-1" aria-labelledby="addTeacherModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="teacherDepartment" placeholder="Enter teacher's department" required>
                            </div>
                            <div class="mb-3">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addTeacherModalLabel">Edit Teacher</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form>
