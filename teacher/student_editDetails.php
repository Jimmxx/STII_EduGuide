...
if ($student_id > 0) {
    ...
    // Fetch previous school information
    $sql_prev = "SELECT * FROM prev_school_info WHERE student_id = ?";
...
while ($row = $result->fetch_assoc()) {
    $selected = ($student['department'] ?? '') == $row['name'] ? 'selected' : '';
    $departmentOptions .= "<option value='{$row['name']}' $selected>{$row['name']}</option>";
}
...
while ($row = $result->fetch_assoc()) {
    $selected = ($student['strand'] ?? '') == $row['name'] ? 'selected' : '';
    $strandOptions .= "<option value='{$row['name']}' $selected>{$row['name']}</option>";
}
...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <h1 class="text-2xl font-bold mb-6 text-center">Edit Student Details</h1>
...
<div class="row mb-5 g-4">  <!-- Increased margin-bottom and added gap -->
    <div class="col-md-3" >
        ...
        <input type="text" class="form-control py-2" id="firstName" name="s_firstname" placeholder="Enter first name" required style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['s_fname'] ?? '') ?>">
    </div>
    <div class="col-md-3">
        <label for="middleName" class="form-label mb-2" style="font-weight: bold;" >Middle Name</label>
        <input type="text" class="form-control py-2" id="middleName" placeholder="Enter middle name" name="s_middlename" style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($student['s_mname'] ?? '') ?>">
    </div>
    <div class="col-md-3">
        <label for="lastName" class="form-label mb-2" style="font-weight: bold;"> Last Name</label>
        <input type="text" class="form-control py-2" id="lastName" name="s_lastname"placeholder="Enter last name" required style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['s_lname'] ?? '') ?>">
    </div>
    <div class="col-md-3">
...
<div class="row mb-5 g-4">  <!-- Increased margin-bottom and added gap -->
    <div class="col-md-3">
        ...
        <input type="date" class="form-control py-2" id="dob" name="s_dob" required style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($student['birthdate'] ?? '') ?>">
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control py-2" id="citizenship" name="citizenship" placeholder="Enter citizenship" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['citizenship'] ?? '') ?>">
    </div>
    <div class="col-md-3">
    ...
    <select class="form-select py-2" id="status" name="s_status" style="border: 2px solid #333; background-color: #f8f9fa;">
        ...
        <option value="Single" <?= ($student['s_status'] ?? '') == 'Single' ? 'selected' : '' ?>>Single</option>
        <option value="Married" <?= ($student['s_status'] ?? '') == 'Married' ? 'selected' : '' ?>>Married</option>
    </select>
</div>
...
<div class="row mb-5 g-4">  <!-- Increased margin-bottom and added gap -->
    <div class="col-md-4">
        ...
        <input type="text" class="form-control py-2" id="religion" name="religion" placeholder="Enter religion" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['religion'] ?? '') ?>">
    </div>
    <div class="col-md-4">
        <label for="tribe" class="form-label mb-2" style="font-weight: bold;">Tribe</label>
        <input type="text" class="form-control py-2" id="tribe" name="tribe" placeholder="Enter tribe" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['tribe'] ?? '') ?>">
    </div>
    <div class="col-md-4">
...
<div class="col-md-6">
    ...
    <div class="row g-2">
       ...
       oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="<?= htmlspecialchars($student['number'] ?? '') ?>">        </div>
    </div>
</div>
    
    <div class="col-md-6">
        <label for="email" class="form-label mb-2" style="font-weight: bold;">Email Address</label>
        <input type="email" class="form-control py-2" name="s_email" id="email" placeholder="Enter email address" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['s_email'] ?? '') ?>">
    </div>
...
<div class="row">
        <div class="col-md-4">
            ...
            <input type="number" class="form-control" id="siblings" name="siblings" placeholder="Number of Siblings" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['siblings'] ?? '') ?>">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="number" class="form-control" id="student_id" name="student_id" placeholder="Enter Student ID" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['student_id'] ?? '') ?>">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="section" name="section" placeholder="Enter Section" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($student['section'] ?? '') ?>">
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 10px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="f_fname" class="form-control" id="fatherName" placeholder="Full Name" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['father_name'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="fatherOccupation" class="form-label" style="font-weight: bold;">Occupation</label>
                        <input type="text" name="f_occupation" class="form-control" id="fatherOccupation" placeholder="Occupation" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['father_occupation'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="fatherAddress" class="form-label" style="font-weight: bold;">Address</label>
                        <input type="text" name="f_address" class="form-control" id="fatherAddress" placeholder="Address" style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($parent['father_address'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                           ...
                           <input name="f_number" type="text" class="form-control" id="mobileNumber" placeholder="Enter mobile number" value="<?= htmlspecialchars($parent['father_number'] ?? '') ?>"
       style="border: 2px solid #333; background-color: #f8f9fa;"
       maxlength="10" 
       minlength="10"
       ...
       oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="f_income" class="form-control" id="fatherIncome" placeholder="Income (PHP)" style="border: 2px solid #333; background-color: #f8f9fa;"   value="<?= htmlspecialchars($parent['father_income'] ?? '') ?>">
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="m_fname" class="form-control" id="motherName" placeholder="Full Name" style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($parent['mother_name'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="motherOccupation" class="form-label" style="font-weight: bold;" >Occupation</label>
                        <input type="text" name="m_occupation" class="form-control" id="motherOccupation" placeholder="Occupation" style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($parent['mother_occupation'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="motherAddress" class="form-label" style="font-weight: bold;">Address</label>
                        <input type="text" name="m_address" class="form-control" id="motherAddress" placeholder="Address" style="border: 2px solid #333; background-color: #f8f9fa;"  value="<?= htmlspecialchars($parent['mother_address'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                             <label for="fatherMobile" class="form-label" style="font-weight: bold;">Mobile Number</label>
                    <div class="d-flex gap-2">
       ...
       oninput="this.value = this.value.replace(/[^0-9]/g, '')"  value="<?= htmlspecialchars($parent['mother_number'] ?? '') ?>">
                    </div>
                    </div>

                    <div class="mb-3">
                        <label for="motherIncome" class="form-label" style="font-weight: bold;">Monthly Income</label>
                        <input type="number" name="m_income" class="form-control" id="motherIncome" placeholder="Income (PHP)" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['mother_income'] ?? '') ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="g_name" class="form-control" id="guardianName" placeholder="Full Name" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['guardian_name'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="guardianOccupation" class="form-label" style="font-weight: bold;">Occupation</label>
                        <input type="text" name="g_occupation" class="form-control" id="guardianOccupation" placeholder="Occupation" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['guradian_occupation'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                        <label for="guardianAddress" class="form-label"style="font-weight: bold;">Address</label>
                        <input type="text" name="g_address" class="form-control" id="guardianAddress" placeholder="Address" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($parent['guardian_address'] ?? '') ?>">
                    </div>
                    <div class="mb-3">
                             <label for="fatherMobile" class="form-label" style="font-weight: bold;">Mobile Number</label>
                    <div class="d-flex gap-2">
                            <input type="text" class="form-control flex-shrink-0" id="countryCode" placeholder="+63" style="border: 2px solid #333; background-color: #f8f9fa; width: 70px;" readonly>
                           <input type="text" name="g_number" class="form-control" id="mobileNumber" placeholder="Enter mobile number" value="<?= htmlspecialchars($parent['guardian_number'] ?? '') ?>"
       style="border: 2px solid #333; background-color: #f8f9fa;"
       maxlength="10" 
       minlength="10"
       pattern="[0-9]{11}"
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="last_schoolname" id="lastSchoolName" placeholder="School Name" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($prevSchool['last_school'] ?? '') ?>">
            </div>
            <div class="mb-3">
                <label for="schoolAddress" class="form-label" style="font-weight: bold;">School Address</label>
                <input type="text" class="form-control" name="last_schooladdress" id="schoolAddress" placeholder="School Address" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($prevSchool['school_address'] ?? '') ?>">
            </div>
        </div>
        <div class="col-md-4">
            <div class="mb-3">
                <label for="yearGraduated" class="form-label" style="font-weight: bold;">Year Graduated/Completed</label>
                <input type="number" class="form-control" name="lastyeargraduated" id="yearGraduated" placeholder="Year Graduated" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($prevSchool['year_graduated'] ?? '') ?>">
            </div>
            <div class="mb-3">
                <label for="reasonForTransfer" class="form-label" style="font-weight: bold;">Reason for Transfer (if applicable)</label>
                <textarea class="form-control" name="reason" id="reasonForTransfer" rows="3" placeholder="Reason for Transfer" style="border: 2px solid #333; background-color: #f8f9fa;" value="<?= htmlspecialchars($prevSchool['reason'] ?? '') ?>"></textarea>
            </div>
        </div>
    </div>
</div>
