...
<body>
    <div class="header">
        ...
        <a href="assessment8.php" class="back-arrow">← previous</a>
        </div> <div>9 out of 10</div>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment10.php"; // Redirect to next question
            } else {
