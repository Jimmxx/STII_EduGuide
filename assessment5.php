...
<html lang="en">
  ...
  <img src="image/2.png" alt="Logo" class="w-200 h-9 bg-transparent " style="margin-top: -5px;">
        ...
        <a href="assessment4.php" class="mt-2 text-sm text-black hover:underline">
          ← previous
        </a>
      </div>
...
How do you approach problem-solving?
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Researching and experimenting </span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Using logic and data  </span>
            <span class="ml-2">📐</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Discussing ideas with others  </span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Using creativity and innovation   </span>
            <span class="ml-2">🎨</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Troubleshooting and hands-on work   </span>
            <span class="ml-2">💼</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment6.php'" 
            ...
            <span>Finding solutions in business and finance  </span>
            <span class="ml-2">👩‍🍳</span>
          </button>
        </div>
