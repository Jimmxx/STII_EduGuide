...
<body>
    <div class="header">
        ...
        <a href="assessment4.php" class="back-arrow">← previous</a>
        </div> <div>5 out of 10</div>
    ...
    <div class="container">
        <h2>How do you prefer to spend your time?</h2>
        <div class="options">
            <div class="option">
                <!-- Sports Illustration -->
                <img src="image/tech.png" alt="Sports">
                <p>Learning about technology</p>
                <button onclick="toggleOption(this)">Play Sports</button>
            </div>
            <div class="option">
                <!-- Board Games Illustration -->
                <img src="image/exercise.png" alt="Board Games">
                <p>Practicing physical activities or sports</p>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment6.php"; // Redirect to next question
            } else {
