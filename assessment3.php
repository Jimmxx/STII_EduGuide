...
<body>
    <div class="header">
        ...
        <a href="assessment2.php" class="back-arrow">← previous</a>
        </div> <div>3 out of 10</div>
    ...
    <div class="container">
        <h2>What fascinates you more?</h2>
        <div class="options">
            <div class="option">
                <!-- Sports Illustration -->
                <img src="image/science.jpg" alt="Sports">
                <p>Conducting science experiments</p>
                <button onclick="toggleOption(this)">Play Sports</button>
            </div>
            <div class="option">
                <!-- Board Games Illustration -->
                <img src="image/art.png" alt="Board Games">
                <p>Creating art or music</p>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment4.php"; // Redirect to next question
            } else {
