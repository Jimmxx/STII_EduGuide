...
<body>
    <div class="header">
        <div class="header-left">
            ...
            <a href="assessment9.php" class="back-arrow">← previous</a>
        </div> <div>10 out of 10</div>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "result.php"; // Redirect to next question
            } else {
