...
<body>
    <div class="header">
        ...
        <a href="assessment.php" class="back-arrow">← previous</a>
        </div> <div>2 out of 10</div>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment3.php"; // Redirect to next question
            } else {
