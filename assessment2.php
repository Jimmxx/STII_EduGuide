    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Conducting experiments</span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Solving math problems</span>
            <span class="ml-2">📐</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Writing, debating, or public speaking</span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Drawing, designing, or performing</span>
            <span class="ml-2">🎨</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Managing businesses or financial planning</span>
            <span class="ml-2">💼</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment3.php'" 
            ...
            <span>Working with hands, fixing, or cooking</span>
            <span class="ml-2">👩‍🍳</span>
          </button>
        </div>
