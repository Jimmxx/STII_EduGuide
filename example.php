  ...
  <body class="bg-gradient-to-br from-blue-100 to-purple-100 font-[PatrickHand]"
    ...
    <header class="flex flex-wrap items-center justify-between p-4 sm:px-8 bg-white/80 backdrop-blur-sm shadow-md">
      <div class="flex flex-col items-start">
        <a href="home_assessment.php" class="flex items-center">
          <img src="image/logo.png" alt="Logo" class="w-12 h-12 mr-2 animate-bounce">
          <h1 class="text-2xl font-bold text-blue-600 font-[ComicNeue]">STII EduGuide</h1>
        </a>
        <a href="assessment.php" class="mt-2 text-sm text-black hover:underline">
          ← previous
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>a) Conducting experiments</span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>b) Solving math problems</span>
            <span class="ml-2">📐</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>c) Writing, debating, or public speaking</span>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>d) Drawing, designing, or performing</span>
            <span class="ml-2">🎨</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>e) Managing businesses or financial planning</span>
            <span class="ml-2">💼</span>
          </button>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          ...
          <button onclick="location.href='assessment2.php'" 
            ...
            <span>f) Working with hands, fixing, or cooking</span>
            <span class="ml-2">👩‍🍳</span>
          </button>
        </div>
