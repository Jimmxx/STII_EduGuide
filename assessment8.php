...
<body>
    <div class="header">
        ...
        <a href="assessment7.php" class="back-arrow">← previous</a>
        </div> <div>8 out of 10</div>
    ...
    <div class="container">
        <h2>Which project would you prefer to do?</h2>
        <div class="options">
            <div class="option">
                <!-- Sports Illustration -->
            ...
            <div class="option">
                ...
                <p>Creating a design or sculpture</p>
    ...
    <script>
        ...
        function validateSelection() {
            if (selectedButton) {
                location.href = "assessment9.php"; // Redirect to next question
            } else {
